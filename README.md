...
* CAMI2
  ...
  - Directory [cami2_kf2vec_tax_assignment](https://github.com/noraracht/kf2vec_inputs9/tree/main/cami2_kf2vec_tax_assignment) contains data and a script that we used to perform taxonomic assignment of CAMI2 set after kf2vec. 
