...
amber_df=read.csv(file.path("results.tsv"),sep="\t",header=T)
...
df1 = read.csv(file.path("taxonomic/Closest_tree_dist_sp/metrics_per_bin.tsv"),sep="\t",header=T)
df2 = read.csv(file.path("taxonomic/DIAMOND 0.9.28/metrics_per_bin.tsv"),sep="\t",header=T)
df3 = read.csv(file.path("taxonomic/Kraken 2.0.8-beta/metrics_per_bin.tsv"),sep="\t",header=T)
df4 = read.csv(file.path("taxonomic/LSHVec cami2/metrics_per_bin.tsv"),sep="\t",header=T)
df5 = read.csv(file.path("taxonomic/MEGAN 6.15.2/metrics_per_bin.tsv"),sep="\t",header=T)
df6 = read.csv(file.path("taxonomic/PhyloPythiaS+ 1.4/metrics_per_bin.tsv"),sep="\t",header=T)
df7 = read.csv( file.path("taxonomic/closest_subset/metrics_per_bin.tsv"),sep="\t",header=T)
df8 = read.csv(file.path("taxonomic/closest_subset_v2/metrics_per_bin.tsv"),sep="\t",header=T)
df9 = read.csv(file.path("taxonomic/tax2tree/metrics_per_bin.tsv"),sep="\t",header=T)
df10 = read.csv(file.path("taxonomic/closest_subset_v3/metrics_per_bin.tsv"),sep="\t",header=T)
df11 = read.csv(file.path("taxonomic/closest_subset_v4/metrics_per_bin.tsv"),sep="\t",header=T)
df12 = read.csv(file.path("taxonomic/closest_subset_v5/metrics_per_bin.tsv"),sep="\t",header=T)
df13 = read.csv(file.path("taxonomic/closest_subset_v6/metrics_per_bin.tsv"),sep="\t",header=T)
df14 = read.csv(file.path("taxonomic/closest_subset_v7/metrics_per_bin.tsv"),sep="\t",header=T)
df15 = read.csv(file.path("taxonomic/closest_subset_v8/metrics_per_bin.tsv"),sep="\t",header=T)
df16 = read.csv(file.path("taxonomic/closest_subset_v9/metrics_per_bin.tsv"),sep="\t",header=T)
df17 = read.csv(file.path("taxonomic/closest_subset_v10/metrics_per_bin.tsv"),sep="\t",header=T)
#df18 = read.csv(file.path("taxonomic/closest_subset_v10_rep/metrics_per_bin.tsv"),sep="\t",header=T)
